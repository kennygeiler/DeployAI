...
from control_plane.services.triage import EventSignals, TriageContext, score_relevance, triage_event
...
def test_triage_out_below_threshold(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("control_plane.services.triage.observe_triage", cap)
    ctx = TriageContext(
...
def test_triage_log_json_uses_hashed_event_and_tenant(
    ...
    caplog.set_level(logging.INFO, logger="control_plane.services.triage")
