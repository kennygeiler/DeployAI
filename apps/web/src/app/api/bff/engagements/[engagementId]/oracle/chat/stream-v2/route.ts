...
/**
 * Agent Kenny v2 chat — LangGraph SSE streaming (scope-v2 §6). CP returns
 * 404 when the feature flag is off, so the client falls back to the v1
 * /chat/stream endpoint automatically.
 */
