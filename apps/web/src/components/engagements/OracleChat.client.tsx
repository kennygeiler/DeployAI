...
export function OracleChat({ engagementId }: { engagementId: string }) {
  ...
  return (
    <aside
      className="border-border bg-paper-50 fixed top-16 right-4 z-40 w-[360px] max-w-[90vw] rounded-lg border shadow-lg"
    ...
    >
      ...
      {open ? (
        ...
        >
          <div className="flex-1 overflow-y-auto px-3 py-2" data-testid="oracle-chat-scroll">
