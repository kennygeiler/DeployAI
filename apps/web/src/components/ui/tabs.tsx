  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-surface data-[state=active]:text-foreground group-data-[variant=default]/tabs-list:data-[state=active]:shadow-btn dark:data-[state=active]:text-foreground",
