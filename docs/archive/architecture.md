...
> Do not use this file for current development — its claims were not re-verified against code. This document describes *intended* architecture; see the source-of-truth spec §5 for what was actually built.
