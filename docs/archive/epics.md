...
> Do not use this file for current development — its claims were not re-verified against code. Retained as historical epic/story breakdown and FR→epic mapping.
