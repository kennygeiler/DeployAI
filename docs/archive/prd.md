...
> Do not use this file for current development — its claims were not re-verified against code. Retained as the historical requirements baseline (79 FR / 78 NFR / 12 DP).
