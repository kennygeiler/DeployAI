...
> Do not use this file for current development — its claims were not re-verified against code. Retained for product vision, GTM, and commercial-model history.
