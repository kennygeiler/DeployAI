...
- **Strategist data realism** (CP loaders, queue durability, digest URLs) — see archived [source-of-truth spec §7](../archive/product/deployai-source-of-truth-spec.md), [oracle-and-digest-pilot.md](../pilot/oracle-and-digest-pilot.md), [queue-durability-modes.md](../pilot/queue-durability-modes.md).
...
- Archived [source-of-truth spec](../archive/product/deployai-source-of-truth-spec.md) — §13 demo / pilot / production staging and FDE pilot minimums (SSO, no dev headers).
