...
**Authoritative tracking:** [delivery-status.yaml](./delivery-status.yaml) · **Honest UX/API posture:** [source-of-truth spec](product/deployai-source-of-truth-spec.md).
