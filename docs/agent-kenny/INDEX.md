...
| Deploy to cloud (Railway) | [`docs/ops/cloud-deploy.md`](../ops/cloud-deploy.md) (step-by-step runbook) + [`docs/ops/cloud-deploy-architecture.md`](../ops/cloud-deploy-architecture.md) (topology + trust boundaries) |
