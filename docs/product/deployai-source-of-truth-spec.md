...
| 5 | Converged deployment-matrix model — structured map on canonical memory | In progress — 5.1–5.2b done, 5.3 underway |
...
| 5.3 | **Matrix BFF & map view** — BFF routes + a map view on the engagement detail page that renders the deployment matrix. | In progress |
